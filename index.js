const {
  ...
  const ownerNumber = ['255763755563']
...
const sessdata = config.SESSION_ID.replace("GOODCHILD-XMD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there GOODCHILD-XMD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet GOODCHILD XMD WhatsApp Bot.\n\n *Thanks for using GOODCHILD-XMD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vao1lnR1nozDF8jBNh3B\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\https://github.com/Goodchildwilliamz/GOODCHILD-XMD\n\n> © Pᴏᴡᴇʀᴇᴅ Bʏ 𓄂𝕚𝕥𝕩.GOODCHILD WILLIAMZ 🔥༽༼ ♡ \ud83d\udda4`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('255792375563', '255762755563', '255763755563');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("255763755563")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("GOODCHILD XMD STARTED ✅");
  });
