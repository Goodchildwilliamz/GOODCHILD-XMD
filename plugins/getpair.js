...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example -* .pair +2557637555XX");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://goodchild-xmd-pair-code-1.onrender.com-2e87c8f59fda.herokuapp.com/pair?phone=${q}`);
        ...
        const doneMessage = "> *GOODCHILD-XMD PAIR COMPLETED*";
